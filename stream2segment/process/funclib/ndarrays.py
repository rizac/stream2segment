"""
Library functions operating on `numpy` arrays
...
def powspec(signal, signal_is_fft=False):
    ...
    see :func:`stream2segment.process.funclib.ndarrays.dfreq` and
...
def triangsmooth(array, winlen_ratio):
    ...
    # possible, and several redundant mathematical expression related to normalizations (e.g., divide and
