...
#   provided)
# """ % {'seg_sel': SEGSEL_PARAMNAME, 'url': THE_SEGMENT_OBJECT_WIKI_URL}


# PROCESS_PY_MAINFUNC = """
# Main processing function. The user should implement here the processing for any
# given segment selected from within from within stream2segment's `imap` or `process`
# functions. Useful links:
#
...
# - ObsPy Stream, Trace UTCDateTime objects, imported in this module by default (for
#   details, see https://docs.obspy.org/packages/)
#
...
# "try ... except" statement, and raise a `SkipSegment`.
...
#
# """.format(USING_S2S_IN_YOUR_PYTHON_CODE_WIKI_URL, THE_SEGMENT_OBJECT_WIKI_URL, SEGMENT_ID_COLNAME)
