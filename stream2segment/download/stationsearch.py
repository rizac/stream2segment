...
from stream2segment.download.channels import (
    lat_col as ch_lat_col,
    lon_col as ch_lon_col,
    net_col,
    sta_col,
    loc_col,
    start_col,
...
def merge_events_stations(
    *,
    ...
    if not ret:
        raise NoSegmentsToDownload(_no_station_found_within_search_area_msg)
    # now concat:
...
_no_station_found_within_search_area_msg = "no stations found within event search area"
