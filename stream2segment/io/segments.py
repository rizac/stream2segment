...
class DataManager(object):
    ...
    def __init__(self, db_uri):
        ...
        iterator = dbh.read(dbh.tables.segments, chunksize=10)
    ...
    def session(self):
        ...
        class (e.g., get_segment, get_metadata)"""
    ...
    def get_segments_table(self):
        return self.dbh.tables[self.dbh.tables.segments]
    ...
    def get_segment(self, index, raw=False, session=None):
        """
