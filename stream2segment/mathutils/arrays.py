...
def powspec(signal, signal_is_fft=False):
    ...
    see :func:`stream2segment.mathutils.arrays.dfreq` and :func:`stream2segment.mathutils.arrays.freqs`,
    respectively
    ...
    signal. Otherwise, :func:`stream2segment.mathutils.arrays.fft`(signal) will be computed first
