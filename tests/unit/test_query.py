...
# ===========================
    ...
    @patch('stream2segment.download.query.yaml_load', return_value={'service1': {'event': 'http:event1'}, 'service2': {'event': 'http:event2', 'station': 'http:station2'}})
...
"""]
    ...
    @patch('stream2segment.download.query.urljoin', return_value='a')
    @patch('stream2segment.download.query.dbsync')
...
"""]
    ...
    @patch('stream2segment.download.query.get_dc_filterfunc')
...
# 23  12          2              n2      s                c3      0.0                 2        2016-05-08 01:45:31.300 2016-05-08 01:44:31 2016-05-08 01:47:31
    ...
    def test_download_save_segments(self, update_segments, insert_segments, mseed_unpack):  #, mock_urlopen_in_async, mock_url_read, mock_arr_time):
        ...
        insert_segments.side_effect = lambda *a, **v: insertdf_napkeys(*a, **v)
