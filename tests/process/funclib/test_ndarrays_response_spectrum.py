...
from stream2segment.process.funclib.ndarrays import ResponseSpectrum as a_ResponseSpectrum
from stream2segment.process.funclib.traces import ResponseSpectrum as t_ResponseSpectrum
from stream2segment.process.funclib.ndarrays import respspec as a_rs
from stream2segment.process.funclib.traces import respspec as t_rs
