...
* A highly customizable processing module to get any user-dependent output. In the examples (command `s2s init`) you will find editable examples for two typical scenarios: create tabular file outputs (e.g., csv, hdf5) or store on the local file system the processed waveform segments.
